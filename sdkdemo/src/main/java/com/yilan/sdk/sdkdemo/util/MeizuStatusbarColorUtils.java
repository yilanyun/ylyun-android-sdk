...
public class MeizuStatusbarColorUtils {
     ...
     * @param color    颜色
     */
    public static boolean setStatusBarDarkIcon(Activity activity, int color) {
        ...
        if (mSetStatusBarColorIcon != null) {
            ...
            if (mStatusBarColorFiled != null) {
                result = setStatusBarDarkIcon(activity, whiteColor, whiteColor);
                if (!result) {
                    result = setStatusBarDarkIcon(activity.getWindow(), color);
                }
            } else {
                result = setStatusBarDarkIcon(activity, whiteColor);
            }
        }
        return result;
    }
    ...
    public static boolean setStatusBarDarkIcon(Window window, int color) {
        boolean result = false;
        try {
            result = setStatusBarColor(window, color);
     ...
     * @param color
     */
    private static boolean setStatusBarColor(Window window, int color) {
        boolean result = false;
    ...
    private static boolean setStatusBarDarkIcon(Activity activity, boolean dark, boolean flag) {
        ...
        if (mSetStatusBarDarkIcon != null) {
            ...
            if (flag) {
                result = setStatusBarDarkIcon(activity.getWindow(), dark);
            }else {
                result = true;
            }
        }
